...
df = pd.read_csv('exp_2_dataset_student_scores (1).csv')   
print("First 5 rows:\n", df.head(), "\n")
print("Last 5 rows:\n", df.tail(), "\n")
X = df.iloc[:, :-1].values   
Y = df.iloc[:, -1].values    
...
## Output:
<img width="1037" height="852" alt="image" src="https://github.com/user-attachments/assets/283481e4-fe67-4227-ba84-6406ecbe2d21" />
<img width="1027" height="826" alt="image" src="https://github.com/user-attachments/assets/4950aa0a-3b73-4f4b-8a4d-b5c36233963d" />
<img width="915" height="197" alt="image" src="https://github.com/user-attachments/assets/64723e00-e83b-493e-9e44-f43324dfcc53" />
